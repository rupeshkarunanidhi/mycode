...
def main():
    ...
    for item in items.get("results"):
        ...
        if args.sword in item.get("name"):
    ...
    print(f"There are {len(finishedlist)} words that contain the word '{args.sword}' in the Pokemon Item API!")
    print(f"List of Pokemon items containing '{args.sword}': ")
    print(matchedwords)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--sword', metavar='SEARCHW',\
    type=str, default='heal', help="Pass in any word. Default is 'ball'")
